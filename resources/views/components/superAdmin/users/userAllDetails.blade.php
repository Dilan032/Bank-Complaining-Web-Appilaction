    ...
    <div class="row mt-2 mb-2 d-flex justify-content-center">
        <div class="col-md-3">
            <div class="p-2 bg-primary-subtle text-primary-emphasis border-bottom border-black border-5 rounded shado">
                ...
                <p class="fs-5">All Bank Administrators <span class="badge text-bg-light px-4 problemImageMainBG">{{$activeAdministratorCount + $inactiveAdministratorCount}}</span></p>
        ...
        <div class="col-md-3">
            <div class="p-2 bg-primary-subtle text-primary-emphasis border-bottom border-black border-5 rounded shado">
                ...
                <p class="fs-5">All Bank Users <span class="badge text-bg-light px-4 problemImageMainBG">{{$activeUserCount + $inactiveUserCount}}</span></p>
                <div class="p-3 bg-white text-dark  rounded">
                    <div class="d-flex justify-content-between px-4 mt-2">
                        🙋‍♂️Active
